...
urlpatterns = patterns('',
    ...
    url(r'^$', RedirectView.as_view(url="/events/{event_slug}/infotv/?slow=1".format(event_slug=settings.INFOTV_DEFAULT_EVENT_SLUG))),
    url(r'^edit/?$', infotv_edit_redirect_view, dict(event=settings.INFOTV_DEFAULT_EVENT_SLUG)),
